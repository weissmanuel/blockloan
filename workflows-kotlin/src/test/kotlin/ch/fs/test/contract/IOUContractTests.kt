package ch.fs.test.contract

import ch.fs.contract.IOUContract
import ch.fs.state.IOUState
...
class IOUContractTests {
    private val ledgerServices = MockServices(listOf("ch.fs.contract", "ch.fs.flow"))
